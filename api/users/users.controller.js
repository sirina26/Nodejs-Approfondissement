...
class UsersController {
  ...
  async update(req, res, next) {
    try {
      ...
      if (req.user.role !== "admin") {
        throw new UnauthorizedError("Only admin users can update users.");
      }
  ...
  async delete(req, res, next) {
    try {
      ...
      if (req.user.role !== "admin") {
        throw new UnauthorizedError("Only admin users can delete users.");
      }
  ...
  async getUserArticles(req, res, next) {
    try {
      ...
      const userArticles = await articlesService.getUserArticlesWithUser(userId);
